...
const EditMachine = () => {
    ...
    return(
        <div id="content-page" className="mx-20 overflow-auto h-full">
            <p className="mb-7 text-3xl font-bold">Maschinen {pid.id}{machineName != '' ? ' (' + machineName + ')' : ''}</p>
            <div>
                <form onSubmit={onSubmitHandler}>
                    <table className="text-sm">
                        <tr>
                            ...
                            <td className="p-1 pl-0">
                                ...
                                required={true} defaultValue={pid.id}
                                /></td>
                    ...
                    <button className="mt-9 border p-1.5 px-3.5 font-bold border-accent-color-1 bg-accent-color-4
                                       hover:bg-accent-color-5 sm:rounded-lg shadow-md text-xs">Maschine entfernen
                    </button>
                </form>
            </div>
        </div>
