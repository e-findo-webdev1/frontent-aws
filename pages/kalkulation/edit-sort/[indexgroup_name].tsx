...
const EditSort = () => {
    ...
    const [isDataLoaded, setIsDataLoaded] = useState<any>();
    ...
    return(
        <div className="overflow-auto h-full px-48 m-auto">
            ...
            <div className="mb-10 sm:rounded-lg shadow-md border overflow-auto bg-gray-50">
                <table className="h-[26.5rem] flex-row w-full table-auto overflow-auto">
                    <thead>
                    <tr className="text-xs text-gray-500 border-b bg-white h-full text-left">
